    ...
    <section className="py-12 sm:py-16 bg-white border-b border-slate-100 relative overflow-hidden">
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto px-6 relative z-10">
        <ScrollReveal direction="up">
          <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-10 shadow-lg space-y-8 relative overflow-hidden">
              ...
              <div className="lg:col-span-5 space-y-5 order-last lg:order-first">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 py-3.5 px-7 rounded-xl bg-gradient-to-r from-pink-500 via-violet-600 to-indigo-600 hover:from-pink-600 hover:to-indigo-700 text-white text-xs font-bold uppercase tracking-wider shadow-md hover:scale-105 hover:shadow-lg hover:shadow-pink-500/20 active:scale-95 transition-all duration-300 cursor-pointer border-0 group"
                  >
                ...
                <div className="relative group overflow-hidden bg-white transition-all duration-500 p-2 rounded-2xl">
                  <div className="relative w-full flex items-center justify-center bg-white min-h-[220px] sm:min-h-[280px]">
                    <img
                      ...
                      className="w-full h-auto max-h-[340px] sm:max-h-[400px] object-contain group-hover:scale-105 transition-transform duration-700 ease-out"
                    />
                  </div>
                </div>
                  ...
                  <div className="flex gap-2.5 animate-scroll-horizontal whitespace-nowrap w-max">
                    {[
                      ...
                      return (
                        <div
                          key={idx}
                          className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-white border border-slate-200/90 hover:border-pink-400 text-slate-900 text-xs font-bold shadow-2xs hover:shadow-md hover:scale-105 transition-all duration-300 shrink-0 cursor-default group"
                        >
                          <div className={`w-6 h-6 rounded-lg bg-gradient-to-br ${item.bg} text-white flex items-center justify-center shrink-0 shadow-2xs group-hover:scale-110 transition-transform`}>
                  ...
                  <div className="flex gap-2.5 animate-scroll-horizontal-reverse whitespace-nowrap w-max">
                    {[
                      ...
                      return (
                        <div
                          key={idx}
                          className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-white border border-slate-200/90 hover:border-violet-400 text-slate-900 text-xs font-bold shadow-2xs hover:shadow-md hover:scale-105 transition-all duration-300 shrink-0 cursor-default group"
                        >
                          <div className={`w-6 h-6 rounded-lg bg-gradient-to-br ${item.bg} text-white flex items-center justify-center shrink-0 shadow-2xs group-hover:scale-110 transition-transform`}>
                            <ItemIcon className="w-3.5 h-3.5" />
                          </div>
