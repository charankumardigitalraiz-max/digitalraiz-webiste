    ...
    <section className="py-10 sm:py-10 bg-gradient-to-b from-white via-purple-50/20 to-white text-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <ScrollReveal direction="left" delay={100} className="lg:col-span-5 flex flex-col justify-center items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {aiPillars.map((pillar, i) => {
              ...
              return (
                <ScrollReveal key={i} direction="up" delay={100 + i * 80}>
                  <div className="group relative p-5 rounded-2xl bg-white border border-slate-200/90 shadow-xs hover:shadow-xl hover:border-purple-400 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-start h-full">
