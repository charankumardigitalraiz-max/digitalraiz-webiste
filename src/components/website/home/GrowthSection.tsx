...
export default function GrowthSection() {
  ...
  return (
    <section className="relative text-slate-900 bg-white font-sans overflow-hidden py-10">
      ...
      <div className="relative z-10 max-w-6xl 2xl:max-w-7xl mx-auto px-6 w-full space-y-12">
        ...
        {/* 3-Card Executive Studio Matrix (Vertical Stack on Mobile, 3-Col Grid on Desktop) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 items-stretch pt-2 pb-4">
          {phases.map((svc, idx) => {
            const Icon = svc.icon;
            const isSelected = activeCard === idx;

            return (
              <ScrollReveal key={idx} delay={idx * 150} direction="up" className="h-full flex flex-col w-full pt-1 pb-1">
                <div
