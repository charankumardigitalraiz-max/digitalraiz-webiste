...
export default function AiCtaBanner() {
  return (
    <section className="w-full bg-gradient-to-r from-pink-50 via-purple-50/70 to-indigo-50 border-t border-b border-slate-200/80 py-8 sm:py-7 px-6 sm:px-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <div className="space-y-1.5 text-center md:text-left max-w-2xl">
          ...
          <p className="text-slate-500 text-xs sm:text-sm font-normal leading-relaxed">
            We combine technical AI expertise with strategic thinking to build intelligent solutions that are practical today and ready for tomorrow.
          </p>
        </div>
