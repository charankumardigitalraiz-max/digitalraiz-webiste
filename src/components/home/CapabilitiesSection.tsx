        ...
        <ScrollReveal direction="up">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-5 pb-4 border-b border-slate-100">
            ...
            <div className="relative inline-flex p-1.5 rounded-2xl bg-slate-100/90 border border-slate-200/80 shadow-inner self-start md:self-auto shrink-0 overflow-hidden">
              ...
              <div 
                className={`absolute top-1.5 bottom-1.5 rounded-xl bg-white shadow-md border transition-all duration-500 ease-out pointer-events-none ${
                  activeStudio === "web" 
              ...
              <button
                ...
                className={`relative z-10 flex items-center gap-2.5 px-4 py-2 rounded-xl font-bold text-xs tracking-wide transition-all duration-300 cursor-pointer ${
                  activeStudio === "web"
              ...
              >
                ...
                <span className={`text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full transition-all duration-300 ${
                  activeStudio === "web" ? "bg-pink-50 text-pink-600 border border-pink-100" : "bg-slate-200 text-slate-500"
                }`}>
                  10
                </span>
              </button>
              ...
              >
                ...
                <span className={`text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-full transition-all duration-300 ${
                  activeStudio === "mobile" ? "bg-indigo-50 text-indigo-600 border border-indigo-100" : "bg-slate-200 text-slate-500"
                }`}>
                  12
                </span>
              </button>
            ...
            <div className="relative group rounded-2xl overflow-hidden bg-white  transition-all duration-300">
              <div className="relative w-full flex items-center justify-center bg-white min-h-[220px] sm:min-h-[280px]">
                <img
                  src={
                    activeStudio === "web"
                      ? "/home/web-development-architecture-premium.png"
                      : "/home/mobile-app-engineering-premium.png"
                  }
