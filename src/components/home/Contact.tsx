                      ...
                      {serviceOptions.map((opt) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center justify-center gap-1.5 p-2 rounded-xl border text-[9.5px] font-mono font-bold transition-all cursor-pointer ${
                              isSelected
                                ? "bg-gradient-to-r from-pink-500 via-violet-600 to-indigo-600 text-white border-transparent shadow-2xs"
                    ...
                    <form onSubmit={submitForm} className="space-y-3.5">
                          ...
                          {serviceOptions.map((opt) => {
                            ...
                            return (
                              <button
                                ...
                                type="button"
                                onClick={() => setFormField("service", opt.label)}
                                className={`flex flex-col items-center justify-center p-2 rounded-xl border text-[10px] font-mono font-bold transition-all cursor-pointer ${
                                  isSelected
                                    ? "bg-gradient-to-r from-pink-500 via-violet-600 to-indigo-600 text-white border-transparent shadow-xs scale-[1.02]"
                                    : "bg-slate-50 hover:bg-slate-100 text-slate-600 border-slate-200/70"
                                }`}
                              >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) => setFormField("message", e.target.value)}
                          placeholder="Describe your goals, tech preferences, or desired timeline..."
                          className="w-full bg-slate-50 border border-slate-200/80 rounded-xl p-3 text-xs font-semibold text-slate-800 placeholder-slate-400 focus:outline-none focus:border-pink-500 focus:bg-white transition-colors resize-none"
                        />
                      </div>
