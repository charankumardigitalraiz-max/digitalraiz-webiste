          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-3.5 text-xs text-slate-600 font-light">
              ...
              <li className="flex gap-3 items-center group">
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-violet-600 to-indigo-600 text-white flex items-center justify-center shrink-0 shadow-xs group-hover:scale-110 transition-transform">
                  <Phone className="w-3.5 h-3.5" />
                </div>
                <div className="flex flex-col gap-0.5">
                  {officeDetails.phones.map((phone, idx) => (
                    <a key={idx} href={`tel:${phone.replace(/[^0-9+]/g, "")}`} className="hover:text-pink-600 transition-colors font-medium text-slate-700">
                      {phone}
                    </a>
                  ))}
                </div>
              ...
              <li className="flex gap-3 items-center group">
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-indigo-600 to-blue-600 text-white flex items-center justify-center shrink-0 shadow-xs group-hover:scale-110 transition-transform">
                  <Mail className="w-3.5 h-3.5" />
                </div>
                <div className="flex flex-col gap-0.5">
                  {officeDetails.emails.map((email, idx) => (
                    <a key={idx} href={`mailto:${email}`} className="hover:text-pink-600 transition-colors font-medium text-slate-700">
                      {email}
                    </a>
                  ))}
                </div>
            ...
            <div className="pt-2 flex items-center gap-2">
              ...
              <a href={officeDetails.socialLinks?.find(s => s.name === "YouTube")?.url || "https://www.youtube.com/@digitalraiz2023/featured"} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-xl bg-white border border-slate-200/80 hover:bg-[#ff0000] hover:border-[#ff0000] text-slate-600 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-3xs" aria-label="Youtube">
              ...
              <a href={officeDetails.socialLinks?.find(s => s.name === "Pinterest")?.url || "https://in.pinterest.com/digitalraiz/"} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-xl bg-white border border-slate-200/80 hover:bg-red-500 hover:border-red-500 text-slate-600 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-3xs" aria-label="Pinterest">
