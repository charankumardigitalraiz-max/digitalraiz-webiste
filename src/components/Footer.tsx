...
import { Mail, Phone, MapPin, ExternalLink, ArrowRight, Search, Share2, Laptop, Smartphone, Home, Users, Headphones, TrendingUp } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-primary via-primary-mid to-primary-dark border-t border-primary-hover/30 pt-24 pb-12 relative overflow-hidden font-sans select-none text-white">
