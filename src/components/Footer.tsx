...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-primary/90 via-primary-mid/90 to-primary-dark/95 border-t border-primary-hover/20 pt-0 pb-12 relative overflow-hidden font-sans select-none text-white">

      {/* Strengths Marquee Band at the very top of Footer */}
      <div className="w-full relative overflow-hidden bg-gradient-to-r from-indigo-900/60 via-indigo-800/50 to-indigo-900/60 py-5 mb-14 border-b border-indigo-900/10">
        {/* Fade overlays at screen edges */}
        <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-indigo-950/20 via-indigo-950/10 to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-indigo-950/20 via-indigo-950/10 to-transparent z-10 pointer-events-none" />
        ...
        <div className="flex animate-scroll-horizontal hover:[animation-play-state:paused] whitespace-nowrap gap-16">
          {[...partnerStrengths, ...partnerStrengths].map((strength, idx) => {
            ...
            return (
              ...
              >
                <span className="text-[10px] font-mono text-pink-200/80 tabular-nums">
                  {String(originalIdx + 1).padStart(2, "0")}
                </span>
                <CheckCircle2 className="w-4 h-4 text-pink-300 shrink-0" />
                <span className="text-xs sm:text-sm font-bold text-white hover:text-pink-100 transition-colors">
                  {strength}
                </span>
              </div>
            );
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.04)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none opacity-80" />

      {/* Ambient background glow */}
      <div className="absolute -top-40 right-1/4 w-[500px] h-[500px] rounded-full bg-pink-500/15 blur-[120px] pointer-events-none -z-10" />

      {/* Giant Watermark background text - behind the links */}
      <div className="absolute top-[38%] left-0 right-0 text-[14vw] font-black text-white/[0.040] leading-none pointer-events-none select-none tracking-tighter z-0 text-center">
        DigitalRaiz
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 mb-10">
          ...
          <div className="lg:col-span-5 space-y-5 lg:pr-4">
            <div className="space-y-3">
              ...
              />
              <p className="text-pink-100/85 text-sm leading-relaxed max-w-sm font-normal text-justify">
            ...
            <div className="pt-4 border-t border-white/10 mt-6">
              <div className="flex items-center gap-3.5 group">
                <div className="w-10 h-10 rounded-xl bg-pink-500/15 flex items-center justify-center border border-pink-500/25 group-hover:scale-105 transition-transform">
                  <Phone className="w-4.5 h-4.5 text-pink-200" />
                </div>
                <div>
                  <span className="text-[10px] font-mono text-pink-200/85 uppercase tracking-wider block">Talk To Our Support</span>
                  <a href="tel:+919494613601" className="text-base font-bold text-white hover:text-pink-100 transition-colors block mt-0.5">+91-9494613601</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-pink-200">Quick Links</h4>
              <ul className="space-y-3">
                {quickLinks.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="group flex items-center gap-2 text-pink-100/90 hover:text-white transition-all duration-200 text-sm font-normal"
                    >
                      <ChevronRight className="w-3.5 h-3.5 text-pink-200 group-hover:text-white group-hover:translate-x-0.5 transition-all duration-200 shrink-0" />
            ...
            <div className="space-y-6">
              <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-pink-200">Address</h4>
              <ul className="space-y-4 text-sm font-normal text-pink-100/90">
                <li className="flex gap-3">
                  <MapPin className="w-5 h-5 text-pink-200 shrink-0 mt-0.5" />
                ...
                <li className="flex gap-3">
                  <Phone className="w-5 h-5 text-pink-200 shrink-0 mt-0.5" />
                ...
                <li className="flex gap-3">
                  <Mail className="w-5 h-5 text-pink-200 shrink-0 mt-0.5" />
                  <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-3 pt-2">
                {/* Facebook */}
                <a href="https://www.facebook.com/digitalraiz/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary-hover/30 border border-primary-hover/40 hover:border-pink-300 text-pink-100 hover:text-white flex items-center justify-center transition-all duration-300 hover:shadow-md" aria-label="Facebook">
                ...
                {/* Twitter (X) */}
                <a href="https://twitter.com/digital_raiz" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary-hover/30 border border-primary-hover/40 hover:border-pink-300 text-pink-100 hover:text-white flex items-center justify-center transition-all duration-300 hover:shadow-md" aria-label="Twitter">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                </a>
                {/* Youtube */}
                <a href="https://www.youtube.com/@digitalraiz2023/featured" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary-hover/30 border border-primary-hover/40 hover:border-pink-300 text-pink-100 hover:text-white flex items-center justify-center transition-all duration-300 hover:shadow-md" aria-label="Youtube">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/digital-raiz/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary-hover/30 border border-primary-hover/40 hover:border-pink-300 text-pink-100 hover:text-white flex items-center justify-center transition-all duration-300 hover:shadow-md" aria-label="LinkedIn">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z\" /></svg>
                </a>
                {/* Pinterest */}
                <a href="https://in.pinterest.com/digitalraiz/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary-hover/30 border border-primary-hover/40 hover:border-pink-300 text-pink-100 hover:text-white flex items-center justify-center transition-all duration-300 hover:shadow-md" aria-label="Pinterest">
        ...
        <div className="pt-8 border-t border-[#4a154b]/30 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-pink-100/70 relative z-20">
