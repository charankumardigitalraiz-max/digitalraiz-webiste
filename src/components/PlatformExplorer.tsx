...
export default function PlatformExplorer() {
  ...
  return (
    <div className="w-full max-w-6xl relative rounded-xl overflow-hidden mx-auto bg-white shadow-sm border border-slate-100/60 flex flex-col lg:block lg:aspect-[2.3/1] group p-5 lg:p-0">
