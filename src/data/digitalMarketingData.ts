...
export const capabilities: MarketingCapability[] = [
  { title: "Search Engine Optimization", desc: "Technical, on-page, and keyword research for long-term organic visibility.", icon: Search, tag: "SEO Search", color: "from-pink-50/70 to-pink-100/20", border: "border-pink-200/70 text-pink-700", img: "/digital-marketing-service/seo-search-chart.webp" },
  { title: "Social Media Marketing", desc: "Brand positioning, content planning, and creative social media management.", icon: Share2, tag: "Social Reach", color: "from-violet-50/70 to-violet-100/20", border: "border-violet-200/70 text-violet-700", img: "/digital-marketing-service/social-media-phone.webp" },
  { title: "Google Ads & Paid PPC", desc: "High-intent paid search, ad messaging, and conversion-focused landing pages.", icon: MousePointerClick, tag: "Google PPC", color: "from-indigo-50/70 to-indigo-100/20", border: "border-indigo-200/70 text-indigo-700", img: "/digital-marketing-service/ppc-ad-cursor.webp" },
  { title: "Content Marketing", desc: "Expertise-driven articles, search copy, and creative brand storytelling.", icon: FileText, tag: "Content Copy", color: "from-emerald-50/70 to-emerald-100/20", border: "border-emerald-200/70 text-emerald-700", img: "/digital-marketing-service/content-creation-notebook.webp" },
  { title: "Local SEO", desc: "Geofenced maps optimization and local business search dominance in Hyderabad.", icon: Compass, tag: "Local Maps", color: "from-amber-50/70 to-amber-100/20", border: "border-amber-200/70 text-amber-700", img: "/digital-marketing-service/local-seo-location.webp" },
  { title: "Lead Generation", desc: "Funnel architecture connecting campaign traffic to genuine business inquiries.", icon: Target, tag: "Lead Funnels", color: "from-rose-50/70 to-rose-100/20", border: "border-rose-200/70 text-rose-700", img: "/digital-marketing-service/conversion-funnel.webp" },
  { title: "Performance Marketing", desc: "Data-informed metrics tracking ROI, cost per acquisition, and conversions.", icon: LineChart, tag: "ROI Metrics", color: "from-cyan-50/70 to-cyan-100/20", border: "border-cyan-200/70 text-cyan-700", img: "/digital-marketing-service/roi-growth-chart.webp" },
  { title: "Online Brand Promotion", desc: "Multi-channel digital presence strengthening authority and recall.", icon: Megaphone, tag: "Brand Recall", color: "from-purple-50/70 to-purple-100/20", border: "border-purple-200/70 text-purple-700", img: "/digital-marketing-service/brand-megaphone.webp" },
  { title: "Campaign Management", desc: "Continuous monitoring, A/B testing, and end-to-end campaign optimization.", icon: Layers, tag: "A/B Testing", color: "from-pink-50/70 to-purple-100/20", border: "border-pink-200/70 text-pink-700", img: "/digital-marketing-service/ab-testing-cards.webp" },
];
