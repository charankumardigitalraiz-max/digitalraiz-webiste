...
export const PORTFOLIO_PROJECTS: ProjectItem[] = [
  {
    ...
    category: "Social",
    tag: "iOS & Android App",
    desc: "Premium dating and matchmaking application configured for location checks, instant chats, and verified profiles.",
  ...
  },
  {
    ...
    features: ["Node.js Backend", "Flutter Mobile App", "Google Maps Integration", "Real Estate Listing Management"],
    tech: ["Flutter Mobile", "Node.js API", "Google Maps SDK", "Firebase"],
    img: "/mobile-application/sherla-properties.jpg",
    logo: "/project-logs/sherla-properties.webp",
    url: "https://play.google.com/store/apps/details?id=com.digitalraiz.gouser&hl=en",
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.digitalraiz.gouser&hl=en",
    metrics: { val1: "20K+", label1: "Downloads", val2: "4.9★", label2: "Rating" }
  },
  ...
  // --- WEB APPLICATIONS ---
  {
    ...
    img: "/websites/Sherla-Properties-Premium-Verified-Real-Estate-Properties.png",
    logo: "/project-logs/sherla-properties.webp",
  ...
  },
  {
    ...
    img: "/websites/India-s-Healthcare-Comparison-Platform-MediCompares.png",
    logo: "/project-logs/MediCompares_Logo.webp",
    url: "#",
  ...
  },
  {
    ...
    img: "/websites/Live-Well-Rehabilitation-Network-Child-Therapy-Center.png",
  ...
  },
  {
    ...
    type: "web",
    category: "Real Estate",
    tag: "Real Estate & Infra Portal",
    desc: "Premier real estate and infrastructure development platform showcasing luxury residential, commercial, and land development projects in Sangareddy and Telangana.",
    features: ["Interactive Plot & Property Maps", "Sangareddy Project Showcase", "Virtual Site Visit Booking", "Instant Lead Routing Engine"],
    tech: ["Next.js", "Tailwind CSS", "React Dynamic Search", "Framer Motion", "Vercel"],
    img: "/websites/Real-estate-company-projects-in-sangareddy-Insaat-infra-Insaat-Infra.png",
    logo: "/project-logs/insaatinfra.png",
    url: "#",
    metrics: { val1: "50+", label1: "Projects", val2: "100%", label2: "HMDA Verified" }
  },
  {
    id: "greenco-estates",
    name: "GreenCo Estates",
    type: "web",
    category: "Real Estate",
    tag: "Luxury Real Estate Portal",
    desc: "Premier real estate and luxury apartment portal showcasing premium gated communities, verified open plots, floor plans, interactive property tours, and instant lead inquiry booking.",
    features: ["Interactive Apartment & Plot Maps", "Gated Community Virtual Tours", "Floor Plan & Pricing Calculator", "Verified HMDA & RERA Listings"],
    tech: ["Next.js", "Tailwind CSS", "React Dynamic Filters", "Node.js REST", "Vercel"],
    img: "/websites/GreenCo-Estate-Luxury-Apartments-Plots.png",
    logo: "/project-logs/greenco-logo.png",
    url: "#",
    metrics: { val1: "100+", label1: "Verified Plots", val2: "100%", label2: "RERA Approved" }
  },
  {
    id: "sri-balaji-solar",
    name: "Sri Balaji Solar Energies",
    type: "web",
    category: "Enterprise",
    tag: "Solar Energy Solutions",
    desc: "Telangana's top solar panel installation and renewable energy company portal, providing residential, commercial, and industrial rooftop solar installation quotes and energy savings calculators.",
    features: ["Solar ROI & Savings Calculator", "Rooftop Solar Quote Generator", "Industrial Clean Energy Directory", "Government Subsidy Helper"],
    tech: ["Next.js", "Tailwind CSS", "React.js", "Node.js API", "AWS Hosting"],
    img: "/websites/Telangana-s-Top-Solar-Panel-Installation-Company-Sri-Balaji-Solar-Energies-.png",
    logo: "/project-logs/sri-balaji.png",
    url: "#",
    metrics: { val1: "10MW+", label1: "Solar Installed", val2: "80%", label2: "Bill Reduction" }
  },
  {
    id: "iebm-hyderabad",
    name: "IEBM Hyderabad",
    type: "web",
    category: "Enterprise",
    tag: "Business Management Institute",
    desc: "Top entrepreneurship and business management institute portal in Hyderabad featuring executive course admissions, incubation hubs, faculty research directories, and online student portals.",
    features: ["Executive Admissions Portal", "Entrepreneurship Incubation Hub", "Faculty & Research Directory", "Online Student Inquiry Engine"],
    tech: ["Next.js", "React.js", "Tailwind CSS", "Node.js API", "PostgreSQL"],
    img: "/websites/Top-Entrepreneurship-Business-Management-Institute-in-Hyderabad-IEBM.png",
    logo: "/project-logs/iebm.png",
    url: "#",
    metrics: { val1: "5K+", label1: "Graduates", val2: "100+", label2: "Startups Incubated" }
  },
  {
    id: "jbfms-services",
    name: "JBFMS Home Services",
    type: "web",
    category: "On-Demand",
    tag: "Home Services Portal",
    desc: "All-in-one home need services platform in Nellore providing a one-stop booking interface for residential maintenance, electrical, plumbing, cleaning, and facility management.",
    features: ["Instant Home Service Booking", "Verified Service Technicians", "Real-Time Service Tracker", "Nellore Coverage Area Locator"],
    tech: ["React.js", "Next.js", "Tailwind CSS", "Node.js REST", "MongoDB"],
    img: "/websites/All-home-need-services-in-nellore-JBFMS-Your-One-Stop-Solution-for-for-your-home-services.png",
    logo: "/project-logs/jbfms.png",
    url: "#",
