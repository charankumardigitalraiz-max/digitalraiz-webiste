...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    keywords: post.tags,
    alternates: {
      canonical: `https://digitalraiz.com/insights/blog/${post.slug}/`,
    },
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://digitalraiz.com/insights/blog/${post.slug}/`,
        ...
        <section className="py-5 bg-slate-50/60 border-t border-slate-100">
          <div className="max-w-6xl 2xl:max-w-7xl mx-auto px-6 space-y-10">
            <div className="flex items-center justify-between border-b border-slate-200/80 pb-4">
              ...
              <Link href="/insights/blog" className="text-xs font-bold text-pink-600 hover:underline flex items-center gap-1">
